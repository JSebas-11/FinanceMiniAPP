...
namespace WebClient.Services.API.ApiService {
    ...
    [GeneratedCode("NSwag", "14.6.3.0 (NJsonSchema v11.5.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial interface IApiService {
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        Task<TickerDto> GetTickerAsync(string symbol, CancellationToken cancellationToken = default(CancellationToken));

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        Task<Result> RefreshTickerAsync(string symbol, CancellationToken cancellationToken = default(CancellationToken));

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        Task TestCorsAsync(CancellationToken cancellationToken = default(CancellationToken));
    ...
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async Task<TickerDto> GetTickerAsync(string symbol, CancellationToken cancellationToken = default(CancellationToken)) {
            ...
            try {
                using (var request_ = new HttpRequestMessage()) {
                    ...
                    // Operation Path: "tickers/{symbol}"
                    urlBuilder_.Append("tickers/");
                    urlBuilder_.Append(Uri.EscapeDataString(ConvertToString(symbol, CultureInfo.InvariantCulture)));
                    ...
                    try {
                        ...
                        if (status_ == 200) {
                            var objectResponse_ = await ReadObjectResponseAsync<TickerDto>(response_, headers_, cancellationToken).ConfigureAwait(false);
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async Task<Result> RefreshTickerAsync(string symbol, CancellationToken cancellationToken = default(CancellationToken)) {
            if (symbol == null) throw new ArgumentNullException("symbol");
            ...
            try {
                ...
                using (var request_ = new HttpRequestMessage()) {
                    ...
                    // Operation Path: "tickers/{symbol}/refresh"
                    urlBuilder_.Append("tickers/");
                    urlBuilder_.Append(Uri.EscapeDataString(ConvertToString(symbol, CultureInfo.InvariantCulture)));
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async Task TestCorsAsync(CancellationToken cancellationToken = default(CancellationToken)) {
            var client_ = _httpClient;
            var disposeClient_ = false;
            try {
                ...
                using (var request_ = new HttpRequestMessage()) {
                    ...
                    // Operation Path: "cors-test"
                    urlBuilder_.Append("cors-test");
        ...
        private string ConvertToString(object value, CultureInfo cultureInfo) {
            ...
            if (value is Enum) {
                ...
                if (name != null) {
                    var field_ = IntrospectionExtensions.GetTypeInfo(value.GetType()).GetDeclaredField(name);
                    if (field_ != null) {
                        var attribute = CustomAttributeExtensions.GetCustomAttribute(field_, typeof(EnumMemberAttribute)) as EnumMemberAttribute;
                        if (attribute != null)
