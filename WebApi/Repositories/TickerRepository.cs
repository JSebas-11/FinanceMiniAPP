...
internal class TickerRepository : ITickerRepository {
    ...
    public async Task<Result> InsertTickerAsync(Ticker ticker) {
        ...
        catch (Exception ex) { return Result.Fail($"Error inserting ticker ({ticker.Symbol}) in DB", ex.Message); }
    }
    ...
    public async Task<Result> UpdateTickerAsync(Ticker ticker) {
        ...
        catch (Exception ex) { return Result.Fail($"Error updating ticker ({ticker.Symbol}) in DB", ex.Message); }
    }
    ...
    public async Task<Result> DeleteTickerAsync(string symbol) {
        ...
        } catch (Exception ex) { return Result.Fail($"Error removing ticker ({symbol}) in DB", ex.Message); }
    }
    #endregion
}